...
/** 把一份 {master, bonus, holiday, config, roster, approved, leave} 的假資料灌進 vm，
 *  整支覆寫 payRead/payClockRead/todayTaipeiStr。payAppend('audit', ...) 也攔下來記錄，
 *  用來驗證「唯讀」——金鑰鎖定那唯一的例外會寫一筆 audit，其餘路徑不應該有任何一筆。 */
function wire(sb, fx) {
